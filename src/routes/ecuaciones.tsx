  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 16px 80px' }}>
        ...
        {/* Header */}
        <header style={{ paddingBottom: 'clamp(16px,3vw,28px)', marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32, flexWrap: 'wrap' }}>
            <div>
              <p style={{ fontSize: 11, color: 'var(--text-dim)', letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 500, marginBottom: 6 }}>
                Álgebra Lineal
              </p>
              <h1 style={{
                fontFamily: 'var(--sans)', fontWeight: 700,
                fontSize: 'clamp(22px,3.5vw,30px)', letterSpacing: '-0.03em', lineHeight: 1,
...
export const Route = createFileRoute('/ecuaciones')({
