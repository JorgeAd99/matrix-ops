...
const PlotWrapper = React.lazy(() => import('@/components/PlotWrapper'));

type GraphMode = '2D' | '3D';

function PlotterPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        {/* ── Header ── */}
        <header style={{ paddingBottom: '24px', marginBottom: 20 }}>
        ...
        <div style={{
          ...
          {plotData ? (
             <Suspense fallback={<div>Cargando graficadora...</div>}><PlotWrapper key={mode} data={plotData} layout={layout} config={config} /></Suspense>
          ) : (
...
export const Route = createFileRoute('/graficadora')({
  component: PlotterPage,
});
